...
export default function HeaderCarousel(props: HeaderCarouselProps) {
    ...
    return slidesData ? (
        <section className='hero-carousel'>
            ...
            {currentSlide ? (
                <div className="w-[calc(100%-40px)] sm:w-[calc(100%-80px)] lg:w-[calc(100%-140px)] absolute left-1/2 -translate-x-1/2 top-[335px] flex flex-col items-center gap-y-4 z-[10] pointer-events-none md:pointer-events-auto sm:top-1/2 sm:-translate-y-[calc(50%+20px)] sm:items-start">
                    {/* titulo */}
