    ...
    return (
        <>
            ...
            {!props.prevBtnDisabled &&
                <div className="absolute left-0 top-0 z-50 flex items-center justify-center md:bg-background/80 w-5 sm:w-10 lg:w-[70px] h-full">
            ...
            {!props.nextBtnDisabled &&
                <div className="absolute right-0 top-0 z-50 flex items-center justify-center md:bg-background/80 w-5 sm:w-10 lg:w-[70px] h-full">
